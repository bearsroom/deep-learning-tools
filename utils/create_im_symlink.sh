...
for line in $(ls everphoto_media/subset_results/text/images_*); do python create_im_symlink.py --src-dir everphoto_media/rnd_2M --dst-dir everphoto_media/subset_results/text/images_with_neg_20160830 --classes classify_200_mxnet/db_meta/text/text_classes.txt --img-list $line --suffix jpg --limit 500; done
